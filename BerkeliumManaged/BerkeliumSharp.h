...
namespace Berkelium {
  namespace Managed {
	...
	public enum class ScriptVariantType : System::UInt32  {
		JSSTRING = 0,
		JSDOUBLE = 1,
		JSBOOLEAN = 2,
		JSNULL = 3,
	...
	public ref class ScriptVariant
	{
	internal:
		Berkelium::Script::Variant * Native;
		ScriptVariant(Berkelium::Script::Variant variant);

	public:
		// Constructors
		ScriptVariant();
		ScriptVariant(System::String ^ str);
		ScriptVariant(System::Double dblval);
		ScriptVariant(System::Int32 intval);
		ScriptVariant(System::Boolean boolval);
		...
		// Static methods
		static ScriptVariant^ BindFunction(System::String^ name, bool synchronous)
		{
			const wchar_t* nameChars = (const wchar_t*)((Marshal::StringToHGlobalUni(name)).ToPointer());
			WideString nameUrlString = WideString::point_to(nameChars);
			Berkelium::Script::Variant variant = Berkelium::Script::Variant::bindFunction(nameUrlString, synchronous);
			Marshal::FreeHGlobal(IntPtr((void*)nameChars));

			return gcnew ScriptVariant(variant);
		}

		// Properties
		property ScriptVariantType Type
		{
			ScriptVariantType get()
			{
				return (ScriptVariantType)(Native->type());
			}
		}
	};
	...
	public delegate void ExternalHostHandler (Window ^ window, System::String ^ message, System::String ^ origin, System::String ^ target);
    public delegate void CreatedWindowHandler (Window ^ window, Window ^ newWindow, Rect ^ initialRect);
	...
	public delegate void JavascriptCallbackHandler (Window^ window, IntPtr replyMsg, System::String ^ origin, System::String ^ funcName, array<ScriptVariant^> ^ args);
	public delegate void RunFileChooserHandler (Window ^ window, int mode, System::String ^ title, System::String ^ defaultFile);
    ...
    public:
      ...
      virtual void onCreatedWindow (::Berkelium::Window *win, ::Berkelium::Window *newWindow, ::Berkelium::Rect &initialRect);
      ...
      virtual void onNavigationRequested(::Berkelium::Window *win, URLString newUrl, URLString referrer, bool isNewWindow, bool &cancelDefaultAction);
      ...
      virtual void onTooltipChanged(::Berkelium::Window *win, ::Berkelium::WideString tooltip);
      virtual void onShowContextMenu(::Berkelium::Window *win, const ::Berkelium::ContextMenuEventArgs& args);
      virtual void onCursorUpdated(::Berkelium::Window *win, const Cursor& newCursor);
	  virtual void onJavascriptCallback(::Berkelium::Window *win, void* replyMsg, ::Berkelium::URLString origin, ::Berkelium::WideString funcName, Script::Variant *args, size_t numArgs);
    ...
    public:
	  ...
	  event ExternalHostHandler ^ ExternalHost;
	  ...
	  event JavascriptCallbackHandler ^ JavascriptCallback;
	  event RunFileChooserHandler ^ RunFileChooser;
	  ...
	  virtual bool NavigateTo (System::String ^ url) {
		IntPtr cstr = Marshal::StringToHGlobalAnsi(url);
		URLString urlString = URLString::point_to((const char*)cstr.ToPointer());
		bool result = Native->navigateTo(urlString);
      ...
      void ExecuteJavascript (System::String ^ javascript) {
		...
		Native->executeJavascript(WideString::point_to(scriptPtr));
      }
      ...
      void InsertCSS (System::String ^ css, System::String ^ id) {
		const wchar_t* idChars = (const wchar_t*)((Marshal::StringToHGlobalUni(id)).ToPointer());
		const wchar_t* cssChars = (const wchar_t*)((Marshal::StringToHGlobalUni(css)).ToPointer());
		WideString idUrlString = WideString::point_to(idChars);
		WideString cssUrlString = WideString::point_to(cssChars);

		Native->insertCSS(cssUrlString, idUrlString);

		Marshal::FreeHGlobal(IntPtr((void*)idChars));
		Marshal::FreeHGlobal(IntPtr((void*)cssChars));
      }

	  void Bind(System::String ^ lvalue, System::String ^ rvalue, bool synchronous)
	  {
		  const wchar_t* lvalueChars = (const wchar_t*)((Marshal::StringToHGlobalUni(lvalue)).ToPointer());
		  const wchar_t* rvalueChars = (const wchar_t*)((Marshal::StringToHGlobalUni(rvalue)).ToPointer());
		  WideString lvalueUrlString = WideString::point_to(lvalueChars);
		  WideString rvalueUrlString = WideString::point_to(rvalueChars);

		  const Berkelium::Script::Variant variantBoundFunction = Berkelium::Script::Variant::bindFunction(rvalueUrlString, synchronous);

		  Native->bind(lvalueUrlString, variantBoundFunction);

		  Marshal::FreeHGlobal(IntPtr((void*)lvalueChars));
		  Marshal::FreeHGlobal(IntPtr((void*)rvalueChars));
	  }

	  void AddBindOnStartLoading(System::String ^ lvalue, System::String ^ rvalue, bool synchronous)
	  {
		  const wchar_t* lvalueChars = (const wchar_t*)((Marshal::StringToHGlobalUni(lvalue)).ToPointer());
		  const wchar_t* rvalueChars = (const wchar_t*)((Marshal::StringToHGlobalUni(rvalue)).ToPointer());
		  WideString lvalueUrlString = WideString::point_to(lvalueChars);
		  ...
		  Native->addBindOnStartLoading(lvalueUrlString, variantBoundFunction);

		  Marshal::FreeHGlobal(IntPtr((void*)lvalueChars));
		  Marshal::FreeHGlobal(IntPtr((void*)rvalueChars));
	  }

	  void AddEvalOnStartLoading(System::String ^ script)
	  {
		  const wchar_t* scriptChars = (const wchar_t*)((Marshal::StringToHGlobalUni(script)).ToPointer());
		  WideString scriptUrlString = WideString::point_to(scriptChars);

		  Native->addEvalOnStartLoading(scriptUrlString);

		  Marshal::FreeHGlobal(IntPtr((void*)scriptChars));
	  }

	  void ClearStartLoading()
	  {
		  Native->clearStartLoading();
	  }

	  void SynchronousScriptReturn(void* reply_msg, ScriptVariant^ result)
	  {
		  Native->synchronousScriptReturn(reply_msg, *(result->Native));
	  }
    ...
    public protected:
      ...
      virtual void OnCreatedWindow (Window ^ newWindow, Rect ^ initialRect) {
        CreatedWindow(this, newWindow, initialRect);
      }
	  ...
	  virtual void OnExternalHost (System::String ^ message, System::String ^ origin, System::String ^ target) {
		  ExternalHost(this, message, origin, target);
      }
	  ...
	  virtual void OnJavascriptCallback(void* replyMsg, System::String ^ origin, System::String ^ funcName, Script::Variant *args, size_t numArgs)
	  {
		  array<ScriptVariant^>^ argsArray = gcnew array<ScriptVariant^>(numArgs);

			for(int i=0; i<numArgs; i++)
			{
				argsArray[i] = gcnew ScriptVariant(args[i]);
			}

		  JavascriptCallback(this, (IntPtr)replyMsg, origin, funcName, argsArray);
	  }

	  virtual void OnRunFileChooser(int mode, System::String ^ title, System::String ^ defaultFile)
	  {
		  RunFileChooser(this, mode, title, defaultFile);
	  }
    };
  }
}
