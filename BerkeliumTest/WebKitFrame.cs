...
namespace BerkeliumWinFormsTest {
    public partial class WebKitFrame : UserControl {
        ...
        public delegate void JavascriptCallbackHandler(Window window, object replyMsg, string origin, string funcName, Berkelium.Managed.ScriptVariant[] args);
        
        public event Action<object, string> AddressChanged;
		public event JavascriptCallbackHandler JavascriptCallback;
        public event Action<object, WebKitFrame, Rectangle> WindowOpened;
        ...
        private void WebKit_JavascriptCallback(Window window, IntPtr replyMsg, string origin, string funcName, ScriptVariant[] args)
        {
            MessageBox.Show("WebKit_JavascriptCallback. Function: '" + funcName + "'");

            for(var i=0; i<args.Length; i++)
            {
                MessageBox.Show("Arg #" + i + " (" + args[i].ToStringValue() + ") '" + args[i].Type.ToString() + "'");
            }
        }
        ...
        private void WebKit_CreatedWindow (Window source, Window newWindow, Rect initialRect) {
    ...
    public class JavascriptCallEventArgs
    {
